          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 8:
                ...
                form.setFieldsValue(_defineProperty({}, recordKey, isMapEditor ? (0, _get.default)(row, namePath) : row));
...
function useEditableArray(props) {
  ...
  var onValuesChange = function onValuesChange(value, values) {
    ...
    var newLineRecordData = _objectSpread(_objectSpread({}, newLineRecordCache === null || newLineRecordCache === void 0 ? void 0 : newLineRecordCache.defaultValue), (0, _get.default)(values, [props.tableName || '', recordKey.toString()].flat(1).filter(function (key) {
      return key || key === 0;
    })));
